...
const DefaultInstallNamespace = "consul"
...
func TestInstall(t *testing.T) {
	...
	for _, _ = range cases {
		...
		t.Run(name, func(t *testing.T) {
			...
			_, err = ctx.KubernetesClient(t).CoreV1().Pods(DefaultInstallNamespace).List(context.Background(), metav1.ListOptions{})
