...
type Command struct {
	...
	flagRootServiceAccountName string
...
func (c *Command) init() {
	...
	c.flags.StringVar(&c.flagRootServiceAccountName, "root-service-account-name", "",
		"Service account name that can register as any service.")
